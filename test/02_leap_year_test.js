...
var isLeapYear = require('../solutions/02_leap_year.js');
...
describe("isLeapYear", function() {
  ...
  it("should return true when given 1984", function() {
    expect(isLeapYear(1984)).to.be.true;
  });

  it("should return false when given 1900", function() {
  ...
  it("should return true when given 2016", function() {
